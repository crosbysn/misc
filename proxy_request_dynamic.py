...
res_user = 'lum-customer-c_6986a326-zone-qichacha-route_err-pass_dyn'
res_password = 'k97wx2y50im1'
center_user = 'lum-customer-c_6986a326-zone-qcc-route_err-pass_dyn'
...
def proxy_request(target_url, firm_string="NULL", use_datacenter=True):
    ...
    returned_page = MultiSessionRetriever('lum-customer-c_6986a326-zone-qichacha', 'k97wx2y50im1', switch_ip_every_n_req, max_failures).retrieve(
