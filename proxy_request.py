...
def proxy_request(target_url, use_datacenter=True):
    ...
    returned_page = MultiSessionRetriever('lum-customer-hl_e847a51f-zone-data_center-route_err-pass_dyn', 'l46rrbi08qyo', switch_ip_every_n_req, max_failures).retrieve(
